...
from mappolicy.envs.metaworld_env import METAWORLD_LANGUAGE_DESCRIPTION, MetaWorldEnv, load_mw_policy
...
def main(args):
    ...
    while episode_idx < args.num_episodes:
        ...
        while not truncated:
            ...
            # print(obs_depth.dtype) float32
            # print(obs_depth.shape) (224,224)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=str(
            pathlib.Path(__file__).resolve().parent.parent.parent / "data_new" / "metaworld"
        ),
    )
